/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a035337380b8983085a781ed917fa878)
// Runtime types generated with workerd@1.20260107.1 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DaemonMCP";
	}
	interface Env {
		DAEMON_REGISTRY: KVNamespace;
		CLOUDFLARE_API_TOKEN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").DaemonMCP>;
	}
}
